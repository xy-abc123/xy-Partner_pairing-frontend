        ...
        <van-form @submit="onSubmit">
            <van-cell-group inset>
                ...
                <van-field v-model="addTeamData.description" rows="4" autosize label="描述" type="textarea"
                    placeholder="请输入留言" />
                <van-field v-model="result" is-link readonly name="datePicker" label="时间选择"
                    :placeholder="addTeamData.expireTime ?? '点击选择时间'" @click="showPicker = true" />
